...
config.bind('ahv', urlCmdHint + 'url.lua --mpvFullscreen {hint-url}')
config.bind('alv', 'spawn url.lua --mpvFullscreen "{url}"')
config.bind('aav', urlCmdRapid + 'url.lua --mpvFullscreen "{hint-url}"')
