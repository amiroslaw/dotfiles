...
# MEDIA
config.bind('<Ctrl-w>', 'spawn mpv.lua --queueMenu')
...
config.bind('aav', 'hint --rapid links spawn -v pueue add -g mpv-fullscreen -- mpv-fullscreen')
...
config.bind('aap', 'hint --rapid links spawn -v pueue add -g mpv-popup -- mpv-popup')
...
config.bind('aaa', 'hint --rapid links spawn -v pueue add -g mpv-audio -- mpv-audio')
