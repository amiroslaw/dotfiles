...
config.bind('aav', 'hint --rapid links spawn -v pueue add -g mpv-fullscreen -- mpv-fullscreen "{hint-url}"')
...
config.bind('aap', 'hint --rapid links spawn -v pueue add -g mpv-popup -- mpv-popup "{hint-url}"')
...
config.bind('aaa', 'hint --rapid links spawn -v pueue add -g mpv-audio -- mpv-audio "{hint-url}"')
