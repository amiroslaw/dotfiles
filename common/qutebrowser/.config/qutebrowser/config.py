...
config.bind('ahd', urlCmdHint+ 'pueue add -g dl-audio -- dl-audio "{hint-url}"')
config.bind('aad', urlCmdRapid + 'pueue add -g dl-audio -- dl-audio "{hint-url}"')
config.bind('ald', 'spawn pueue add -g dl-audio -- dl-audio "{url}"')
config.bind('ahy', urlCmdHint+ 'pueue add -g dl-video -- dl-video "{hint-url}"')
config.bind('aay', urlCmdRapid + 'pueue add -g dl-video -- dl-video "{hint-url}"')
config.bind('aly', 'spawn pueue add -g dl-video -- dl-video "{url}"')
...
config.bind('ahv', urlCmdHint + '-v pueue add -g mpv-fullscreen -- mpv-fullscreen {hint-url}')
config.bind('alv', 'spawn -v pueue add -g mpv-fullscreen -- mpv-fullscreen "{url}"')
config.bind('aav', urlCmdRapid + '-v pueue add -g mpv-fullscreen -- mpv-fullscreen "{hint-url}"')
config.bind('ahp', urlCmdHint + '-v pueue add -g mpv-popup -- mpv-popup {hint-url}')
config.bind('alp', 'spawn -v pueue add -g mpv-popup -- mpv-popup {url}')
config.bind('aap', urlCmdRapid + '-v pueue add -g mpv-popup -- mpv-popup "{hint-url}"')
config.bind('aha', urlCmdHint + '-v pueue add -g mpv-audio -- mpv-audio {hint-url}')
config.bind('ala', 'spawn -v pueue add -g mpv-audio -- mpv-audio "{url}"')
config.bind('aaa', urlCmdRapid + '-v pueue add -g mpv-audio -- mpv-audio "{hint-url}"')
config.bind(';p', 'hint video userscript yt.lua')
config.bind(';P', 'spawn --userscript yt.lua')
config.bind('alm', 'spawn -v mpv.lua --onlineList --input "{url}"')
