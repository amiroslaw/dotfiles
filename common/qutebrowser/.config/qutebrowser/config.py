...
config.bind('ahk', urlCmdHint+ 'url.lua kindle-send "{hint-url}"')
config.bind('aak', urlCmdRapid + 'url.lua kindle "{hint-url}"')
config.bind('alk', 'spawn url.lua kindle-send "{url}"')
