...
WARNING: Some of the configurations in this repository are X11 specific. On 2026-01-09 I moved to Wayland, and I switched from stow to chezmoi; that new repository you can find here https://github.com/amiroslaw/chezmoi[amiroslaw/chezmoi]
